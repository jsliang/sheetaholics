...
class Sheetaholics_DottedLined ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = _("Sheetaholics: Dotted Lined Sheet"), pos = wx.DefaultPosition, size = wx.Size( 300,550 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.txt_dotnline = wx.StaticText( self, wx.ID_ANY, _("Dot and Line"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		self.txt_dotnline.Wrap( -1 )
		gbSizer.Add( self.txt_dotnline, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 3 ), wx.ALIGN_CENTER|wx.ALL, 5 )
		
		self.txt_gridsize = wx.StaticText( self, wx.ID_ANY, _("Grid Size:"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		self.txt_gridsize.Wrap( -1 )
		gbSizer.Add( self.txt_gridsize, wx.GBPosition( 1, 0 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_RIGHT, 5 )
		
		self.txt_mm_0 = wx.StaticText( self, wx.ID_ANY, _("mm"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		self.txt_mm_0.Wrap( -1 )
		gbSizer.Add( self.txt_mm_0, wx.GBPosition( 1, 2 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		
		self.txt_dotcolor = wx.StaticText( self, wx.ID_ANY, _("Dot Color:"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		...
		self.tc_gridsize = wx.TextCtrl( self, wx.ID_ANY, _("8"), wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer.Add( self.tc_gridsize, wx.GBPosition( 1, 1 ), wx.GBSpan( 1, 1 ), wx.EXPAND, 5 )
		
		self.txt_dotdiameter = wx.StaticText( self, wx.ID_ANY, _("Dot Diameter:"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		self.txt_dotdiameter.Wrap( -1 )
		gbSizer.Add( self.txt_dotdiameter, wx.GBPosition( 3, 0 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_RIGHT, 5 )
		
		self.tc_dotdiameter = wx.TextCtrl( self, wx.ID_ANY, _("0.4"), wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer.Add( self.tc_dotdiameter, wx.GBPosition( 3, 1 ), wx.GBSpan( 1, 1 ), 0, 5 )
		
		self.txt_mm_1 = wx.StaticText( self, wx.ID_ANY, _("mm"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		self.txt_mm_1.Wrap( -1 )
		gbSizer.Add( self.txt_mm_1, wx.GBPosition( 3, 2 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		
		self.txt_linecolor = wx.StaticText( self, wx.ID_ANY, _("Line Color:"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		...
		self.txt_pagewidth = wx.StaticText( self, wx.ID_ANY, _("Page Width:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.txt_pagewidth.Wrap( -1 )
		gbSizer.Add( self.txt_pagewidth, wx.GBPosition( 12, 0 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_RIGHT, 5 )
		
		self.tc_pagewidth = wx.TextCtrl( self, wx.ID_ANY, _("210"), wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer.Add( self.tc_pagewidth, wx.GBPosition( 12, 1 ), wx.GBSpan( 1, 1 ), wx.EXPAND, 5 )
		
		self.txt_mm_7 = wx.StaticText( self, wx.ID_ANY, _("mm"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		self.txt_mm_7.Wrap( -1 )
		gbSizer.Add( self.txt_mm_7, wx.GBPosition( 12, 2 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		
		self.txt_pageheight = wx.StaticText( self, wx.ID_ANY, _("Page Height:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.txt_pageheight.Wrap( -1 )
		gbSizer.Add( self.txt_pageheight, wx.GBPosition( 13, 0 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_RIGHT, 5 )
		
		self.tc_pageheight = wx.TextCtrl( self, wx.ID_ANY, _("297"), wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer.Add( self.tc_pageheight, wx.GBPosition( 13, 1 ), wx.GBSpan( 1, 1 ), wx.EXPAND, 5 )
		
		self.txt_mm_8 = wx.StaticText( self, wx.ID_ANY, _("mm"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		self.txt_mm_8.Wrap( -1 )
		gbSizer.Add( self.txt_mm_8, wx.GBPosition( 13, 2 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		
		self.txt_numpages = wx.StaticText( self, wx.ID_ANY, _("Number of Pages"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		...
		self.txt_numberofpages = wx.StaticText( self, wx.ID_ANY, _("Number of Pages:"), wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		self.txt_numberofpages.Wrap( -1 )
		gbSizer.Add( self.txt_numberofpages, wx.GBPosition( 15, 0 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_RIGHT, 5 )
		
		self.tc_pagecount = wx.TextCtrl( self, wx.ID_ANY, _("2"), wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer.Add( self.tc_pagecount, wx.GBPosition( 15, 1 ), wx.GBSpan( 1, 2 ), wx.EXPAND, 5 )
		
		self.btn_genpdf = wx.Button( self, wx.ID_ANY, _("Generate PDF"), wx.DefaultPosition, wx.DefaultSize, 0 )
