...
class Sheetaholics_DottedLined ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Sheetaholics: 點線筆記頁 V1.1", pos = wx.DefaultPosition, size = wx.Size( 500,350 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		fgSizer = wx.FlexGridSizer( 2, 1, 5, 5 )
		...
		fgSizer_dotnline = wx.FlexGridSizer( 7, 3, 5, 5 )
		fgSizer_dotnline.AddGrowableCol( 1 )
		...
		sbSizer_dotnline.Add( fgSizer_dotnline, 1, wx.ALL|wx.EXPAND, 5 )
		
		gbSizer_settings.Add( sbSizer_dotnline, wx.GBPosition( 0, 0 ), wx.GBSpan( 2, 1 ), wx.ALL|wx.EXPAND, 5 )
		
		sbSizer_margin = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"頁面邊界" ), wx.VERTICAL )
		
		fgSizer_margin = wx.FlexGridSizer( 6, 3, 5, 5 )
		fgSizer_margin.AddGrowableCol( 1 )
		fgSizer_margin.AddGrowableRow( 0 )
		fgSizer_margin.AddGrowableRow( 5 )
		fgSizer_margin.SetFlexibleDirection( wx.BOTH )
		fgSizer_margin.SetNonFlexibleGrowMode( wx.FLEX_GROWMODE_SPECIFIED )
		
		
		fgSizer_margin.AddSpacer( ( 0, 0), 1, wx.EXPAND, 5 )
		...
		fgSizer_margin.Add( self.tc_innermargin, 0, wx.EXPAND, 5 )
		...
		fgSizer_margin.Add( self.tc_outermargin, 0, wx.EXPAND, 5 )
		...
		fgSizer_margin.Add( self.tc_topmargin, 0, wx.EXPAND, 5 )
		...
		fgSizer_margin.Add( self.tc_bottommargin, 0, wx.EXPAND, 5 )
		...
		sbSizer_margin.Add( fgSizer_margin, 1, wx.ALL|wx.EXPAND, 5 )
		
		gbSizer_settings.Add( sbSizer_margin, wx.GBPosition( 0, 1 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.EXPAND, 5 )
		
		sbSizer_pagecount = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"輸出頁數" ), wx.VERTICAL )
		
		fgSizer_pagecount = wx.FlexGridSizer( 3, 3, 5, 5 )
		fgSizer_pagecount.AddGrowableCol( 1 )
		fgSizer_pagecount.AddGrowableRow( 0 )
		fgSizer_pagecount.AddGrowableRow( 2 )
		fgSizer_pagecount.SetFlexibleDirection( wx.BOTH )
		fgSizer_pagecount.SetNonFlexibleGrowMode( wx.FLEX_GROWMODE_SPECIFIED )
		
		
		fgSizer_pagecount.AddSpacer( ( 0, 0), 1, wx.EXPAND, 5 )
		...
		fgSizer_pagecount.Add( self.txt_numberofpages, 0, wx.ALIGN_RIGHT|wx.BOTTOM|wx.TOP, 5 )
		
		self.tc_pagecount = wx.TextCtrl( self, wx.ID_ANY, u"2", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer_pagecount.Add( self.tc_pagecount, 0, wx.EXPAND, 5 )
		
		self.m_staticText58 = wx.StaticText( self, wx.ID_ANY, u"頁", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText58.Wrap( -1 )
		fgSizer_pagecount.Add( self.m_staticText58, 0, wx.BOTTOM|wx.TOP, 5 )
		...
		sbSizer_pagecount.Add( fgSizer_pagecount, 1, wx.ALL|wx.EXPAND, 5 )
		
		gbSizer_settings.Add( sbSizer_pagecount, wx.GBPosition( 2, 0 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.EXPAND, 5 )
		
		sbSizer_papersize = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"紙張尺寸" ), wx.VERTICAL )
		
		fgSizer_papersize = wx.FlexGridSizer( 4, 3, 5, 5 )
		fgSizer_papersize.AddGrowableCol( 1 )
		fgSizer_papersize.AddGrowableRow( 0 )
		fgSizer_papersize.AddGrowableRow( 3 )
		fgSizer_papersize.SetFlexibleDirection( wx.BOTH )
		fgSizer_papersize.SetNonFlexibleGrowMode( wx.FLEX_GROWMODE_SPECIFIED )
		
		
		fgSizer_papersize.AddSpacer( ( 0, 0), 1, wx.EXPAND, 5 )
		...
		sbSizer_papersize.Add( fgSizer_papersize, 1, wx.ALL|wx.EXPAND, 5 )
		
		gbSizer_settings.Add( sbSizer_papersize, wx.GBPosition( 1, 1 ), wx.GBSpan( 2, 1 ), wx.ALL|wx.EXPAND, 5 )
		...
		gSizer2.Add( self.btn_genpdf, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, 5 )
		
		fgSizer_footer = wx.FlexGridSizer( 2, 2, 0, 0 )
		...
		fgSizer_footer.Add( self.m_staticText_author, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_BOTTOM, 5 )
		
		self.m_staticText57 = wx.StaticText( self, wx.ID_ANY, u"jsliang (jsliang.tw@gmail.com)", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText57.Wrap( -1 )
		fgSizer_footer.Add( self.m_staticText57, 0, wx.ALL, 5 )
		...
		fgSizer_footer.Add( self.m_staticText_github, 0, wx.ALL|wx.ALIGN_BOTTOM|wx.ALIGN_RIGHT, 5 )
		...
		fgSizer_footer.Add( self.m_hyperlink_github, 0, wx.ALL|wx.ALIGN_BOTTOM, 5 )
		
		gSizer2.Add( fgSizer_footer, 1, wx.ALIGN_BOTTOM|wx.ALIGN_RIGHT, 5 )
		
		fgSizer.Add( gSizer2, 1, wx.EXPAND, 5 )
